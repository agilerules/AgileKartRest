 ...
 */
package org.AgileKartRest.security;
...
import static org.AgileKartRest.security.model.IdentityModelManager.findByLoginName;
...
public class SecurityInitializer {
    ...
    public void createAdminAccount(PartitionManager partitionManager) {
        IdentityManager identityManager = partitionManager.createIdentityManager();
        String email = "admin@agilerulesconsultants.com";
        ...
        AkUsers person = new AkUsers();

        person.setUserFirstName("Almight");
        person.setUserLastName("Administrator");
        person.setUserEmail(email);

        MyUser admin = new MyUser(person.getUserEmail());
