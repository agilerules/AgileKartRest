 ...
 */
package org.AgileKartRest.security.model;

import org.AgileKartRest.entity.AkUsers;
import org.AgileKartRest.security.authentication.JWSToken;
...
public class IdentityModelManager {
    ...
    public MyUser createAccount(UserRegistration request) {
        ...
        person.setUserEmail(request.getEmail());
        person.setUserFirstName(request.getFirstName());
        person.setUserLastName(request.getLastName());
