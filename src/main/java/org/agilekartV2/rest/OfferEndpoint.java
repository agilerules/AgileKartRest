...
import org.agilekartV2.model.Offer;
...
public class OfferEndpoint
{
   ...
   {
      TypedQuery<Offer> findByIdQuery = em.createQuery("SELECT DISTINCT o FROM Offer o WHERE o.offerId = :entityId ORDER BY o.offerId", Offer.class);
   ...
   {
      TypedQuery<Offer> findAllQuery = em.createQuery("SELECT DISTINCT o FROM Offer o ORDER BY o.offerId", Offer.class);
