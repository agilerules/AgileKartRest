...
import org.agilekartV2.model.LoyaltyProgramTier;
...
public class LoyaltyProgramTierEndpoint
{
   ...
   {
      TypedQuery<LoyaltyProgramTier> findByIdQuery = em.createQuery("SELECT DISTINCT l FROM LoyaltyProgramTier l WHERE l.tierId = :entityId ORDER BY l.tierId", LoyaltyProgramTier.class);
   ...
   {
      TypedQuery<LoyaltyProgramTier> findAllQuery = em.createQuery("SELECT DISTINCT l FROM LoyaltyProgramTier l ORDER BY l.tierId", LoyaltyProgramTier.class);
   ...
   @Path("/{id:[0-9][0-9]*}")
   @Consumes("application/json")
   public Response update(LoyaltyProgramTier entity)
   {
      try
      {
