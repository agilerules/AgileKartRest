...
import org.agilekartV2.model.LoyaltyProgramMerchant;
...
public class LoyaltyProgramMerchantEndpoint
{
   ...
   {
      TypedQuery<LoyaltyProgramMerchant> findByIdQuery = em.createQuery("SELECT DISTINCT l FROM LoyaltyProgramMerchant l WHERE l.loyaltyProgramMerchantId = :entityId ORDER BY l.loyaltyProgramMerchantId", LoyaltyProgramMerchant.class);
   ...
   {
      TypedQuery<LoyaltyProgramMerchant> findAllQuery = em.createQuery("SELECT DISTINCT l FROM LoyaltyProgramMerchant l ORDER BY l.loyaltyProgramMerchantId", LoyaltyProgramMerchant.class);
   ...
   @Path("/{id:[0-9][0-9]*}")
   @Consumes("application/json")
   public Response update(LoyaltyProgramMerchant entity)
   {
      try
      {
