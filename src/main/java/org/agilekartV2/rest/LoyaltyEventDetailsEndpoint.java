...
import org.agilekartV2.model.LoyaltyEventDetails;
...
public class LoyaltyEventDetailsEndpoint
{
   ...
   {
      TypedQuery<LoyaltyEventDetails> findByIdQuery = em.createQuery("SELECT DISTINCT l FROM LoyaltyEventDetails l WHERE l.loyaltyEventDetailsId = :entityId ORDER BY l.loyaltyEventDetailsId", LoyaltyEventDetails.class);
   ...
   {
      TypedQuery<LoyaltyEventDetails> findAllQuery = em.createQuery("SELECT DISTINCT l FROM LoyaltyEventDetails l ORDER BY l.loyaltyEventDetailsId", LoyaltyEventDetails.class);
   ...
   @Path("/{id:[0-9][0-9]*}")
   @Consumes("application/json")
   public Response update(LoyaltyEventDetails entity)
   {
      try
      {
