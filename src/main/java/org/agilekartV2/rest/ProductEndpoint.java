...
import org.agilekartV2.model.Product;
...
public class ProductEndpoint
{
   ...
   {
      TypedQuery<Product> findByIdQuery = em.createQuery("SELECT DISTINCT p FROM Product p WHERE p.productId = :entityId ORDER BY p.productId", Product.class);
   ...
   {
      TypedQuery<Product> findAllQuery = em.createQuery("SELECT DISTINCT p FROM Product p ORDER BY p.productId", Product.class);
